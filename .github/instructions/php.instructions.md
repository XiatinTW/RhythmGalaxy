...
CREATE TABLE music_songs (
    ...
    upload_time DATETIME NOT NULL COMMENT '上架時間',
...
CREATE TABLE music_user_playlists (
    ...
    playdescription TEXT COMMENT '簡介',
...
CREATE TABLE music_charts (
    chart_id   VARCHAR(36) NOT NULL PRIMARY KEY COMMENT '排行榜ID',
    chart_name VARCHAR(20) NOT NULL COMMENT '排行榜名稱',
...
CREATE TABLE music_chart_songs (
    ...
    FOREIGN KEY (song_id) REFERENCES music_songs(song_id),
    FOREIGN KEY (chart_id) REFERENCES music_charts(chart_id)
);
